...
class ResetPassword extends Notification
{
    ...
    protected function buildMailMessage($url)
    {
        return (new MailMessage)
            ...
            ->line(Lang::get('Has recibido este correo electrónico porque hemos recibido una solicitud para restablecer la contraseña de tu cuenta.'))
            ...
            ->line(Lang::get('Si no solicitaste el restablecimiento de contraseña, no se requiere ninguna acción adicional.'));
    }
