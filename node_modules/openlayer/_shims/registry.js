...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'openlayer/shims/${shims.kind}'\` before importing anything else from openlayer`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'openlayer/shims/${shims.kind}'\` after \`import 'openlayer/shims/${exports.kind}'\``);
    }
