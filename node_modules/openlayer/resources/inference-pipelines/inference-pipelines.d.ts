...
export declare class InferencePipelines extends APIResource {
     ...
     */
    retrieve(inferencePipelineId: string, query?: InferencePipelineRetrieveParams, options?: Core.RequestOptions): Core.APIPromise<InferencePipelineRetrieveResponse>;
