    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <form action="{{ route('admin-entrenador.dietas.update', $dieta) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="nombre" id="nombre" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('nombre', $dieta->nombre) }}" required>
                        ...
                        <div>
                            ...
                            <input type="number" name="calorias_diarias" id="calorias_diarias" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('calorias_diarias', $dieta->calorias_diarias) }}" required>
                    ...
                    <div>
                        ...
                        <textarea name="descripcion" id="descripcion" rows="4" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500">{{ old('descripcion', $dieta->descripcion) }}</textarea>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="number" step="0.1" name="proteinas_g" id="proteinas_g" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('proteinas_g', $dieta->proteinas_g) }}" required>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" name="carbohidratos_g" id="carbohidratos_g" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('carbohidratos_g', $dieta->carbohidratos_g) }}" required>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.1" name="grasas_g" id="grasas_g" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring-indigo-500" value="{{ old('grasas_g', $dieta->grasas_g) }}" required>
                        ...
                        @error('imagen') <span class="text-red-500 text-sm mt-1">{{ $message }}</span> @enderror
                         ...
                         @if($dieta->image_url)
                            <div class="mt-4">
                                ...
                                <img src="{{ Storage::url($dieta->image_url) }}" alt="Imagen actual de {{ $dieta->nombre }}" class="mt-2 rounded-md h-24 w-auto">
                            </div>
                        @endif
                    </div>
