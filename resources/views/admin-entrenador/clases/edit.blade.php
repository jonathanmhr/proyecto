<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8 bg-gray-900 text-gray-100 min-h-screen">
        ...
        <h1 class="text-3xl font-bold text-white mb-6">Editar Clase: <span class="text-red-500">{{ $clase->nombre }}</span></h1>
        ...
        <form action="{{ route('admin-entrenador.clases.update', $clase) }}" method="POST">
            ...
            <div class="bg-gray-800 shadow-lg rounded-xl p-6 border border-gray-700 space-y-6">
                ...
                <div>
                    ...
                    <input type="date" name="fecha_inicio" id="fecha_inicio" value="{{ old('fecha_inicio', $clase->fecha_inicio) }}"
                ...
                <div>
                    ...
                    <input type="date" name="fecha_fin" id="fecha_fin" value="{{ old('fecha_fin', $clase->fecha_fin) }}"
                        min="{{ $hoy }}" max="{{ $maxFecha }}"
                        class="w-full p-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:border-red-500 focus:ring-red-500 transition duration-200" required>
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="ubicacion" id="ubicacion" value="{{ old('ubicacion', $clase->ubicacion) }}"
                ...
                <div>
                    ...
                    <select name="nivel" id="nivel" 
                        ...
                        <option value="principiante" {{ (old('nivel', $clase->nivel) == 'principiante') ? 'selected' : '' }}>
                            Principiante</option>
                ...
                <div>
                    ...
                    <input type="number" name="cupos_maximos" id="cupos_maximos" value="{{ old('cupos_maximos', $clase->cupos_maximos) }}"
                        min="5" max="30" 
                        class="w-full p-3 bg-gray-700 text-white border border-gray-600 rounded-lg focus:outline-none focus:border-red-500 focus:ring-red-500 transition duration-200" required>
                </div>
    ...
    @push('scripts')
        <script>
            document.addEventListener("DOMContentLoaded", function() {
                // Ensure Feather Icons are replaced if available
                if (window.feather) {
                    feather.replace();
                }
