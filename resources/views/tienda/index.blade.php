<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <form method="GET" action="{{ route('tienda.index') }}" class="bg-gray-800 p-6 rounded-2xl shadow-lg border border-gray-700 mb-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-x-6 gap-y-8 items-end">

                <!-- Filtro de Búsqueda -->
                <div class="lg:col-span-2">
                    <label for="search" class="block text-sm font-semibold text-gray-400 mb-2">Buscar por producto</label>
                    <div class="relative">
                        <div class="absolute pr-1 inset-y-0 left-0 flex items-center pl-3.5 pointer-events-none">
                        ...
                        <input
                            ...
                            id="search"
                            value="{{ $searchTerm ?? '' }}"
                            {{-- CORRECCIÓN: Aumentamos el padding izquierdo para separar el texto del icono --}}
