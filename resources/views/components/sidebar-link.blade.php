...
<a href="{{ route($route) }}"
   class="flex items-center gap-3 text-gray-300 hover:bg-orange-700 hover:text-red-500 px-3 py-2 rounded-lg transition-all" {{-- CAMBIADO: text-gray-300, hover:bg-orange-700, hover:text-red-500 --}}
