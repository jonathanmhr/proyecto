            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-4 relative">
                    <input id="email" type="email" name="email" :value="old('email')" required autofocus placeholder="Correo electrónico"
                        class="w-full pl-10 pr-3 py-3 rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                ...
                <div class="mb-4 relative">
                    <input id="password" type="password" name="password" required placeholder="Contraseña"
                        class="w-full pl-10 pr-10 py-3 rounded-lg bg-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    <div class="absolute inset-y-0 left-3 flex items-center pointer-events-none">
                        <x-icon-lock />
                    </div>
