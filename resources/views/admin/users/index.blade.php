<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <!-- Buscador -->
        <div class="bg-white shadow-md rounded-lg mb-6 p-4 flex flex-col md:flex-row md:justify-between items-center gap-4">
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-5 text-sm text-gray-800">
                                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-2">
                                    <!-- Asignar rol -->
                                    <form method="POST" action="{{ route('admin.users.assignRole', $user->id) }}" class="flex gap-2 items-center">
                                        @csrf
                                        <select name="role"
