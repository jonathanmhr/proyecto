<x-app-layout>
    ...
    {{-- Encabezado --}}
<div class="bg-white p-6 rounded-lg shadow-md space-y-4 md:space-y-0 md:flex md:items-center md:justify-between">
    <div>
    ...
    <div class="flex flex-col sm:flex-row gap-4 mt-2 sm:mt-0">
