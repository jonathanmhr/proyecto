<x-app-layout>
    <div class="max-w-7xl mx-auto px-4 py-6 space-y-6">
        ...
        <div class="bg-white p-6 rounded-lg shadow-md space-y-4 md:space-y-0 md:flex md:items-end md:justify-between">
            <div>
            ...
            <div class="w-full md:w-auto flex flex-col md:flex-row md:items-end gap-4">
                <form method="GET" action="{{ route('admin.usuarios.index') }}" class="flex flex-col sm:flex-row gap-4 w-full">
        ...
        <div id="confirm-modal" class="fixed inset-0 z-50 hidden bg-black bg-opacity-40 flex items-center justify-center">
            <div class="bg-white p-6 rounded-lg shadow-lg max-w-sm w-full">
                ...
                <div class="flex justify-end gap-2">
                    <button onclick="closeModal()" class="px-4 py-2 bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-md">Cancelar</button>
                    <button id="confirm-button" class="px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md">Confirmar</button>
                </div>
            </div>
        </div>
