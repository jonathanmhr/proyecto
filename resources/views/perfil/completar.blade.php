<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-6 bg-gray-800 rounded">
        <form action="{{ route('perfil.guardar') }}" method="POST" autocomplete="off" >
            ...
            <div class="grid grid-cols-1 gap-6">
                <!-- Fecha de Nacimiento -->
                <div class="mb-4">
                    <label for="fecha_nacimiento" class="block text-sm font-medium text-gray-100">Fecha de nacimiento</label>
                ...
                <!-- Peso -->
                <div class="mb-4">
                    <label for="peso" class="block text-sm font-medium text-gray-100">Peso (kg)</label>
                ...
                <!-- Altura -->
                <div class="mb-4">
                    <label for="altura" class="block text-sm font-medium text-gray-100">Altura (cm)</label>
                ...
                <!-- Objetivo -->
                <div class="mb-4">
                    <label for="objetivo" class="block text-sm font-medium text-gray-100">Objetivo</label>
                ...
                <!-- Nivel -->
                <div class="mb-4">
                    <label for="id_nivel" class="block text-sm font-medium text-gray-100">Nivel</label>
