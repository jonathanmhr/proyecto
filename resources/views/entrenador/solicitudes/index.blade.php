                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            @foreach ($solicitudesPendientes as $solicitud)
                                <tr>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $solicitud->usuario->name }}</td>
                                    <td class="px-6 py-4 text-sm text-gray-900">{{ $solicitud->clase->nombre }}</td>
                                    <td class="px-6 py-4 flex space-x-2">
                                        ...
                                        <div id="modal-aceptar-{{ $solicitud->id }}"
                                            ...
                                            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md text-center">
                                                <h3 class="text-lg font-semibold mb-4 break-words leading-relaxed">
                                                    ¿Confirmas que deseas<br>aceptar esta solicitud?
                                                </h3>
                                        ...
                                        <div id="modal-rechazar-{{ $solicitud->id }}"
                                            ...
                                            <div class="bg-white p-6 rounded-lg shadow-lg w-full max-w-md text-center">
                                                <h3 class="text-lg font-semibold mb-4 break-words leading-relaxed">
                                                    ¿Confirmas que deseas<br>rechazar esta solicitud?
                                                </h3>
