<x-app-layout>
    ...
    <div class="container mx-auto px-4 py-12 bg-[#111828] text-gray-100 min-h-screen">
        <h1
            class="font-extrabold text-5xl md:text-6xl text-white mb-12 text-center md:text-left tracking-tight leading-tight animate-fade-in-down">
            👋 ¡Bienvenido de nuevo, <span
                class="text-red-500 block md:inline-block mt-2 md:mt-0">{{ auth()->user()->name }}</span>!
        </h1>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6">
                ...
                <a href="{{ route('entrenador.clases-individuales.create') }}"
                    ...
                    <i data-feather="plus-circle"
                        class="w-10 h-10 text-white mb-3 group-hover:scale-110 transition-transform"></i>
                ...
                <a href="{{ route('entrenador.solicitudes.index') }}"
                    ...
                    <i data-feather="bell"
                        class="w-10 h-10 text-white mb-3 group-hover:animate-shake-quick transition-transform"></i>
                ...
                <a href="{{ route('entrenador.solicitudes.index') }}"
                    ...
                    <i data-feather="calendar"
                        class="w-10 h-10 text-white mb-3 group-hover:rotate-6 transition-transform"></i>
        ...
        <div
            class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 p-8 rounded-2xl shadow-xl bg-[#1A2234] border border-[#2A344D]">
            {{-- Tarjeta 1: Resumen General (Azul como en la imagen) --}}
            <div
                class="bg-gradient-to-br from-blue-800 to-blue-600 p-8 rounded-2xl shadow-2xl border border-blue-700 hover:shadow-blue-500/50 transition-all duration-500 transform hover:-translate-y-2 group">
                ...
                <div class="text-lg text-blue-100 space-y-4">
                    <p class="flex justify-between items-center">
                        <span class="opacity-90">Clases Grupales Activas:</span>
                        <span class="font-bold text-3xl text-green-300">{{ $clases->count() }}</span>
                        </p>
                        <p class="flex justify-between items-center">
                            <span class="opacity-90">Clases Individuales Activas:</span>
                            <span class="font-bold text-3xl text-cyan-300">{{ $clasesIndividuales->count() }}</span>
                        </p>
                        </p>
                        <p class="flex justify-between items-center">
            ...
            <div
                class="bg-gradient-to-br from-purple-800 to-purple-600 p-8 rounded-2xl shadow-2xl border border-purple-700 hover:shadow-purple-500/50 transition-all duration-500 transform hover:-translate-y-2 group col-span-1 md:col-span-2 lg:col-span-1">
                <h2 class="text-3xl font-extrabold text-[#F3F4F6] mb-6 flex items-center gap-4">
                    <i data-feather="book-open"
                        class="w-8 h-8 text-purple-300 group-hover:scale-110 transition-transform"></i>
                    Mis Clases
                </h2>
                <div class="space-y-6">
                        ...
                        <div class="border-b border-purple-700 pb-6 last:border-b-0">
                            ...
                            <a href="{{ route('entrenador.clases-individuales.edit', $clase->id_clase) }}"
                                ...
                                <i data-feather="arrow-right"
                                    class="inline-block ml-1 w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                            </a>
                        </div>
                    @empty
                        <p class="text-purple-100 opacity-80 text-base italic">Aún no tienes clases programadas. ¡Es
                            hora de crear la primera!</p>
                    @endforelse
                    ...
                    <a href="{{ route('entrenador.clases-individuales.create') }}"
                        class="mt-8 inline-flex items-center bg-purple-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-purple-700 transition-all duration-300 shadow-md text-base">
            ...
            <div
                class="bg-gradient-to-br from-green-800 to-green-600 p-8 rounded-2xl shadow-2xl border border-green-700 hover:shadow-green-500/50 transition-all duration-500 transform hover:-translate-y-2 group">
                <h2 class="text-3xl font-extrabold text-[#F3F4F6] mb-6 flex items-center gap-4">
                    <i data-feather="activity"
                        class="w-8 h-8 text-green-300 group-hover:animate-bounce-icon transition-transform"></i>
                    Mis Entrenamientos
                </h2>
                <div class="space-y-6">
                    ...
                    @forelse ($entrenamientos->take(3) as $entrenamiento)
                        <div class="border-b border-green-700 pb-6 last:border-b-0">
                            ...
                            <p class="text-sm text-green-100 opacity-90">Tipo: <span
                                    class="font-medium">{{ $entrenamiento->tipo }}</span></p>
                            <p class="text-sm text-green-100 opacity-90">Duración: <span
                    ...
                    @empty
                        <p class="text-green-100 opacity-80 text-base italic">Aún no has creado ningún entrenamiento.
                            ¡Inspírate y crea el primero!</p>
                    @endforelse
                    ...
                    <a href="{{ route('entrenador.entrenamientos.create') }}"
                        class="mt-8 inline-flex items-center bg-green-600 text-white px-6 py-3 rounded-full font-semibold hover:bg-green-700 transition-all duration-300 shadow-md text-base">
                        <i data-feather="plus" class="w-5 h-5 mr-2"></i>
            ...
            <div
                class="bg-gradient-to-br from-red-800 to-red-600 p-8 rounded-2xl shadow-2xl border border-red-700 hover:shadow-red-500/50 transition-all duration-500 transform hover:-translate-y-2 group">
                <h2 class="text-3xl font-extrabold text-[#F3F4F6] mb-6 flex items-center gap-4">
                    <i data-feather="bell"
                        class="w-8 h-8 text-red-300 group-hover:animate-shake transition-transform"></i>
                    Solicitudes Pendientes
                </h2>
                @if ($solicitudesPendientes->count() > 0)
                    <p class="text-red-100 mb-6 text-base leading-relaxed">
                        ¡Atención! Tienes <span
                            class="font-bold text-red-300">{{ $solicitudesPendientes->count() }}</span>
                    ...
                    <a href="{{ route('entrenador.solicitudes.index') }}"
                        ...
                        <i data-feather="arrow-right"
                            class="inline-block ml-2 w-5 h-5 group-hover:translate-x-1 transition-transform"></i>
                    </a>
                @else
            ...
            <div
                class="bg-gradient-to-br from-yellow-800 to-yellow-600 p-8 rounded-2xl shadow-2xl border border-yellow-700 hover:shadow-yellow-500/50 transition-all duration-500 transform hover:-translate-y-2 group col-span-1 md:col-span-2 lg:col-span-1">
                <h2 class="text-3xl font-extrabold text-[#F3F4F6] mb-6 flex items-center gap-4">
                    <i data-feather="calendar"
                        class="w-8 h-8 text-yellow-300 group-hover:rotate-3 transition-transform"></i>
                    Mis Reservas
                </h2>
                <div class="space-y-6">
                        ...
                        <div class="border-b border-yellow-700 pb-6 last:border-b-0">
                            ...
                            <div class="mt-4">
                                @if ($reserva->estado == 'pendiente')
                                    <span
                                        class="bg-yellow-500 text-white rounded-full px-3 py-1 text-xs font-bold shadow-md">Pendiente</span>
                                @elseif($reserva->estado == 'aceptada')
                                    <span
                                        class="bg-green-500 text-white rounded-full px-3 py-1 text-xs font-bold shadow-md">Aceptada</span>
                                @else
                                    <span
                                        class="bg-red-500 text-white rounded-full px-3 py-1 text-xs font-bold shadow-md">Rechazada</span>
                                @endif
                            </div>
                            <a href="{{ route('entrenador.reservas.show', $reserva->id) }}"
                                class="inline-flex items-center text-blue-300 hover:text-blue-200 font-medium mt-4 transition-colors duration-200 text-sm group">
                                Ver Detalles <i data-feather="arrow-right"
                                    class="inline-block ml-1 w-4 h-4 group-hover:translate-x-1 transition-transform"></i>
                            </a>
                        </div>
                    @empty
                        <p class="text-yellow-100 opacity-80 text-base italic">No tienes reservas de usuarios para tus
                            clases aún.</p>
                    @endforelse
                    ...
                    <p class="text-yellow-200 text-sm mt-3">¡Sigue creando clases increíbles para atraer más reservas!
                    </p>
                </div>
                <div class="mt-6">
                    <a href="{{ route('entrenador.solicitudes.index') }}"
            ...
            <div
                class="bg-gradient-to-br from-emerald-800 to-emerald-600 p-8 rounded-2xl shadow-2xl border border-emerald-700 hover:shadow-emerald-500/50 transition-all duration-500 transform hover:-translate-y-2 group">
                <h2 class="text-3xl font-extrabold text-[#F3F4F6] mb-6 flex items-center gap-4">
                    <i data-feather="check-circle"
                        class="w-8 h-8 text-emerald-300 group-hover:rotate-12 transition-transform"></i>
                    Estado de Clases
                </h2>
                <div class="text-lg text-emerald-100 space-y-4">
                    <p class="flex justify-between items-center">
                        <span class="opacity-90">Clases Aceptadas:</span>
                        <span id="clases-aceptadas-count"
                            class="font-bold text-3xl text-emerald-300">Cargando...</span>
                    </p>
                    <p class="flex justify-between items-center">
                        <span class="opacity-90">Clases Pendientes:</span>
                        <span id="clases-pendientes-count"
                            class="font-bold text-3xl text-yellow-300">Cargando...</span>
                    </p>
                    <p class="flex justify-between items-center">
