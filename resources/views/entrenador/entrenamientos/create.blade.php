<x-app-layout>
    <x-slot name="header">
        {{-- Tu header original. El título principal se gestiona en el contenido. --}}
    ...
    <div class="py-8 md:py-12 bg-gray-900 min-h-screen">
        <div class="max-w-xl md:max-w-4xl lg:max-w-6xl mx-auto sm:px-4 lg:px-6">
            ...
            {{-- Contenedor para el título principal y el botón "Volver" --}}
            <div class="flex justify-between items-center mb-8">
                <h2 class="font-bold text-3xl text-white leading-tight">
                Crear Nuevo Entrenamiento
                </h2>
                {{-- Botón de Volver a la derecha del todo --}}
                <a href="{{ route('entrenador.dashboard') }}" class="inline-flex items-center px-6 py-3 border border-gray-600 text-gray-300 font-semibold rounded-md shadow-sm bg-gray-700 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition ease-in-out duration-150">
                    Volver
                </a>
            </div>
            ...
            <div class="bg-gray-800 rounded-xl shadow-2xl border border-gray-700 p-6 md:p-8" x-data="{ fases: [] }">
                <form method="POST" action="{{ route('entrenador.entrenamientos.store') }}" enctype="multipart/form-data">
                    @csrf
