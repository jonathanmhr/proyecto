...
<?php $component->withAttributes([]); ?>
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            ...
            <a href="<?php echo e(route('admin-entrenador.clases.create')); ?>"
                ...
                <tbody>
                    <?php $__currentLoopData = $clases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b hover:bg-gray-50">
                            <td class="px-4 py-2"><?php echo e($clase->nombre); ?></td>
                            <td class="px-4 py-2">
                                
                                <?php echo e($clase->entrenador ? $clase->entrenador->name : 'No asignado'); ?>

                            </td>
                            <td class="px-4 py-2"><?php echo e($clase->fecha); ?></td>
                            <td class="px-4 py-2">
                                <a href="<?php echo e(route('admin-entrenador.clases.edit', $clase)); ?>"
                                    class="text-yellow-500 hover:text-yellow-600">Editar</a>
                                <!-- Botón para abrir el modal de eliminación -->
                                <button onclick="openModal(<?php echo e($clase->id); ?>)" class="text-red-500 hover:text-red-600 ml-4">Eliminar</button>
                            </td>
                        </tr>
...
<?php endif; ?>
<?php /**PATH /var/www/gimnasio/resources/views/admin-entrenador/clases/index.blade.php ENDPATH**/ ?>