    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white shadow rounded-xl p-4">
                ...
                <p class="text-3xl font-bold text-blue-500"><?php echo e($totalClases); ?></p>
            </div>

            <!-- Total de entrenadores -->
            <div class="bg-white shadow rounded-xl p-4">
                <h2 class="text-lg font-semibold text-gray-700 mb-2">Entrenadores</h2>
                <p class="text-3xl font-bold text-green-500"><?php echo e($totalEntrenadores); ?></p>
            </div>

            <!-- Total de alumnos -->
            <div class="bg-white shadow rounded-xl p-4">
                <h2 class="text-lg font-semibold text-gray-700 mb-2">Alumnos</h2>
                <p class="text-3xl font-bold text-purple-500"><?php echo e($totalAlumnos); ?></p>
            </div>

            <!-- Total de entrenamientos -->
            <div class="bg-white shadow rounded-xl p-4">
                <h2 class="text-lg font-semibold text-gray-700 mb-2">Entrenamientos</h2>
                <p class="text-3xl font-bold text-indigo-500"><?php echo e($totalEntrenamientos); ?></p>
            </div>

            <!-- Solicitudes Pendientes -->
            <div class="bg-white shadow rounded-xl p-4">
                <h2 class="text-lg font-semibold text-gray-700 mb-2">Solicitudes Pendientes</h2>
                <p class="text-3xl font-bold text-yellow-500"><?php echo e($totalSolicitudesPendientes); ?></p>
            </div>
        </div>
        ...
        <div class="mt-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                <!-- Gestionar Clases -->
                <a href="<?php echo e(route('admin-entrenador.clases.index')); ?>"
                ...
                <!-- Gestionar Alumnos -->
                <a href="<?php echo e(route('admin-entrenador.alumnos.index')); ?>"
                ...
                <a href="<?php echo e(route('admin-entrenador.entrenadores.index')); ?>"
                ...
                <a href="<?php echo e(route('admin-entrenador.entrenamientos.index')); ?>"
                ...
                <a href="<?php echo e(route('admin-entrenador.solicitudes.index')); ?>"
...
<?php endif; ?>
<?php /**PATH /var/www/gimnasio/resources/views/admin-entrenador/dashboard.blade.php ENDPATH**/ ?>