...
class CheckoutController extends Controller
{
    ...
    public function procesar(Request $request)
    {
        ...
        try {
            ...
            $factura->nombre_cliente = $validatedData['nombre_facturacion'];
            $factura->email_cliente = $validatedData['email_facturacion'];
            $factura->direccion_cliente = $validatedData['direccion_facturacion'];
            $factura->save();
